    ...
    return Padding(
      ...
      child: Material(
        ...
        child: InkWell(
                ...
                Flexible(
                  child: Text(
                    ...
                    style: Theme.of(context)
                        .textTheme
                        .titleMedium
                        ?.copyWith(color: Colors.black, fontSize: 14), // Reduced the fontSize
                    maxLines: 3, // Increased the maxLines
          ...
          overflow: TextOverflow.ellipsis,// Change the fontSize value as needed
                    ),
